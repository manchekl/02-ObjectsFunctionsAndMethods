...
def try_methods_and_functions():
    ...
    sally.pen=rg.Pen('Blue',5)
    sally.backward(150)

    sally.speed=1
    draw_many_squares(sally,2,100,30)

    sally.speed=5
    sally.pen=rg.Pen('Red',5)
    draw_many_squares(sally,10,50,15)

    sally.speed=100
    sally.pen=rg.Pen("Red",35)
    draw_many_squares(sally,8,300,60)

    sally.pen=rg.Pen('black', 3)

    sally.backward(200)
    sally.draw_circle(30)
    sally.draw_square(50)
