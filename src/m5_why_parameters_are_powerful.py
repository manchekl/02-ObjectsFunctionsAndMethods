...
def main():
    ...
    #even_better_draw_circles(rg.Point(100,50),20,14,'purple',6)
    #even_better_draw_circles(rg.Point(-200,0),10,4,'blue',2)

    even_better_draw_circles(rg.Point(-100,100),10,10,'orange',4)
    even_better_draw_circles(rg.Point(100,100),10,10,'pink',4)
    even_better_draw_circles(rg.Point(100,-100),10,10,'blue',4)
    even_better_draw_circles(rg.Point(-100,-100),10,10,'green',4)
    even_better_draw_circles(rg.Point(0,0),5,25,'purple',2)
...
def even_better_draw_circles(point,r,num,color,thick):
